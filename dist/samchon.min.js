...
t.CartesianProduct=e
var n=function(){function t(t,e){this.n_=t,this.r_=e,this.size_=Math.pow(t,e),this.divider_array=new Array
...
e.push(r)}return e},t}()
t.RepeatedPermutation=n
var r=function(){function t(t,e){this.n_=t,this.r_=e,this.size_=t
...
t.Factorial=o}(e=t.library||(t.library={}))}(samchon||(samchon={}))
var samchon
!function(t){var e
...
return 0==n.length&&(n=e.SPACE_ARRAY),e.ltrim.apply(e,[e.rtrim.apply(e,[t].concat(n))].concat(n))},e.ltrim=function(t){for(var n=[],r=1;r<arguments.length;r++)n[r-1]=arguments[r]
...
var i=e._Fetch_substitute_index(n)
if(i==Number.MAX_VALUE)break
var s="{"+i+"}"
if(null==r[0])n=e.replaceAll(n,s,"NULL")
else if("number"==typeof r[0])n=e.replaceAll(n,s,String(r[0]))
else if("string"==typeof r[0])n=e.replaceAll(n,s,"'"+r[0]+"'")
else{if(void 0!=r[0].toXML){var a=r[0].toXML()
a instanceof t.XML&&(r[0]=a)}n=e.replaceAll(n,s,"'"+r[0].toString()+"'")}r.shift()}return n},e._Fetch_substitute_index=function(t){for(var n=e.betweens(t,"{","}"),r=Number.MAX_VALUE,o=0;o<n.length;o++){var i=Number(n[o])
...
r+="."+e.repeat("0",l)+s}return r},e.percentFormat=function(t,n){return void 0===n&&(n=2),e.numberFormat(100*t,n)+" %"},e}()
...
this.replyData(r),0==r.isHold()&&r.complete()}else this.replyData(e)},e}()
