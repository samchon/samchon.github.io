...
declare namespace samchon.collections {
    ...
    class CollectionEvent<T> extends library.BasicEvent {
         ...
         */
        constructor(type: string, first: std.base.Iterator<T>, last: std.base.Iterator<T>);
        constructor(type: "insert", first: std.base.Iterator<T>, last: std.base.Iterator<T>);
        constructor(type: "erase", first: std.base.Iterator<T>, last: std.base.Iterator<T>);
        constructor(type: "refresh", first: std.base.Iterator<T>, last: std.base.Iterator<T>);
        /**
         ...
         */
        readonly first: std.base.Iterator<T>;
        /**
         * An {@link Iterator} to the final position in this {@link CollectionEvent}.
         */
        readonly last: std.base.Iterator<T>;
        /**
         * @inheritdoc
         */
        preventDefault(): void;
...
declare namespace samchon.collections {
    ...
    namespace ICollection {
         ...
         * @hidden
         */
        function _Dispatch_CollectionEvent<T>(collection: ICollection<T>, type: string, first: std.base.Iterator<T>, last: std.base.Iterator<T>): void;
        /**
         * @hidden
         */
...
declare namespace samchon.library {
     ...
     * @author Jeongho Nam <http://samchon.org>
     */
    class CartesianProduct implements ICaseGenerator {
        /**
         * @hidden
         */
        private digits_;
...
declare namespace samchon.library {
     ...
     * @author Jeongho Nam <http://samchon.org>
     */
    class Permutation implements ICaseGenerator {
        /**
         * @hidden
         */
        private size_;
...
declare namespace samchon.library {
     ...
     * @author Jeongho Nam <http://samchon.org>
     */
    class Factorial extends Permutation {
        /**
...
declare namespace samchon.library {
     ...
     * @author Jeongho Nam <http://samchon.org>
     */
    class RepeatedPermutation implements ICaseGenerator {
        /**
         * @hidden
         */
        private size_;
...
declare namespace samchon.library {
    ...
    class GAPopulation<T, GeneArray extends std.base.IArrayContainer<T>> {
         ...
         */
        constructor(obj: GAPopulation<T, GeneArray>);
        /**
         ...
         */
        constructor(geneArray: GeneArray, size: number, compare: (x: GeneArray, y: GeneArray) => boolean, cloner: (obj: GeneArray) => GeneArray);
        /**
         * Genes representing the population.
         */
        getChildren(): std.base.IArrayContainer<GeneArray>;
        /**
         ...
         * comparison function.
         */
        getCompare(): (x: GeneArray, y: GeneArray) => boolean;
        /**
         * Copy constructor of the *GeneArray*.
         */
        getCloner(): (obj: GeneArray) => GeneArray;
        /**
...
declare namespace samchon.library {
    ...
    class GeneticAlgorithm {
         ...
         */
        evolveGeneArray<T, GeneArray extends std.base.IArrayContainer<T>>(individual: GeneArray, population: number, generation: number, compare: (left: GeneArray, right: GeneArray) => boolean, cloner: (obj: GeneArray) => GeneArray): GeneArray;
        /**
         ...
         */
        private crossover<T, GeneArray>(population, parent1, parent2);
        /**
...
declare namespace samchon.library {
    ...
    class StringUtil {
         ...
         * @hidden
         */
        private static _Substitute_sql_string(str);
        /**
         * @hidden
         */
...
declare namespace samchon.protocol {
    ...
    abstract class WebCommunicator extends _CommunicatorBase {
         ...
         * @hidden
         */
        private _Handle_message(message);
        /**
         * @hidden
         */
...
declare namespace samchon.templates.slave {
    ...
    abstract class SlaveSystem implements protocol.IProtocol {
        ...
        constructor();
        sendData(invoke: protocol.Invoke): void;
        abstract replyData(invoke: protocol.Invoke): void | Promise<void>;
        /**
         * @hidden
         */
        protected _Reply_data(invoke: protocol.Invoke): void;
        private _Complete_process(pInvoke);
    }
}
declare namespace samchon.templates.parallel {
    /**
