...
(function (boxologic) {
    ...
    var st_Instance = (function () {
         ...
         */
        function st_Instance(width, height, length) {
            // INIT MEMBERS
            this.width = width;
            this.height = height;
            this.length = length;
     ...
     *		   in Hiswill Co., Ltd.
     */
    var Scrapped = (function () {
        function Scrapped(cumx, cumz) {
    ...
    var Boxologic = (function () {
        ...
        function Boxologic(wrapper, instanceArray) {
            ...
            this.leftInstances = new hiswill.packer.InstanceArray();
        }
        /* -----------------------------------------------------------
            ENCODER & DECODER
        ----------------------------------------------------------- */
        ...
        Boxologic.prototype.encode = function () {
            ...
            for (var i = 0; i < this.instanceArray.size(); i++) {
                var box = new Box(this.instanceArray.at(i));
                this.total_box_volume += box.volume;
                this.box_array[i] = box;
            }
            // SCRAP_LIST
            this.scrap_list.pushBack(new Scrapped());
            /////////////////////////////////////
            // BEST VARIABLES
            /////////////////////////////////////
        ...
        Boxologic.prototype.decode = function () {
            ...
            for (var i = 0; i < this.box_array.size(); i++) {
                ...
                if (box.is_packed == true) {
                    var wrap = new hiswill.packer.Wrap(this.wrapper, instance, box.cox, box.coy, box.coz);
            ...
            while (true) {
                ...
                if (prev.equals(this.scrap_list.end()) && next.equals(this.scrap_list.end())) {
                    ...
                    if (this.cbox_layout_width == this.scrap_min_z.value.cumx) {
                        ...
                        var scrap = new Scrapped(this.cbox_layout_width, this.scrap_min_z.value.cumz + this.cbox_layout_length);
                    ...
                    if (this.cbox_layout_width == this.scrap_min_z.value.cumx) {
                        ...
                        if (this.scrap_min_z.value.cumz + this.cbox_layout_length == next.value.cumz) {
                            ...
                            var scrap = new Scrapped(this.scrap_min_z.value.cumx, this.scrap_min_z.value.cumz + this.cbox_layout_length);
                    ...
                    if (this.cbox_layout_width == this.scrap_min_z.value.cumx - prev.value.cumx) {
                        ...
                        if (this.scrap_min_z.value.cumz + this.cbox_layout_length == prev.value.cumz) {
                            ...
                            var scrap = new Scrapped(prev.value.cumx + this.cbox_layout_width, this.scrap_min_z.value.cumz + this.cbox_layout_length);
...
(function (hiswill) {
    ...
    })(packer = hiswill.packer || (hiswill.packer = {}));
})(hiswill || (hiswill = {}));
    ...
    (function (packer_2) {
        ...
        var InstanceForm = (function (_super) {
            ...
            InstanceForm.prototype.toInstanceArray = function () {
                var instanceArray = new packer_2.InstanceArray();
                instanceArray.insert(instanceArray.end(), this.count, this.instance);
                return instanceArray;
            };
            return InstanceForm;
        }(samchon.protocol.Entity));
